...
$.supersized({
	...
	slides 					:  	[			// Slideshow Images
										{image : 'img/slides/slide1.jpg', title : '<h1>Hi, we are <span class="pink raleway">Pixopolus</span></h1>', thumb : 'img/slides/slide1_thumb.jpg'},
										{image : 'img/slides/slide2.jpg', title : '<h1>Photographer<br>&Design<span class="pink raleway">Agency</span></h1>', thumb : 'img/slides/slide2_thumb.jpg'},
										{image : 'img/slides/slide3.jpg', title : '<h1>with an eye for <span class="pink raleway">detail.</span></h1>', thumb : 'img/slides/slide3_thumb.jpg'},
										{image : 'img/slides/slide4.jpg', title : '<h1>Based in <br><span class="pink raleway">New York</span></h1>', thumb : 'img/slides/slide4_thumb.jpg'}
										],		
